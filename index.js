...
let einstein_text = "In 1915, Albert Einstein, German-American physicist, proposed the theory of general relativity. This theory states that smallest distance between two points is the path which a beam of light takes, called geodesics. Einstein and his colleagues actually did not like the idea that black holes could exist, but despitet his, general relativity provdides the framework for how modern physicsts understand black holes."
let child_text = "Karl Schawzschild, German astronomer, became a professor of the University of Gottingen’s observatory, later on he became the director of the Astrophysical Observatory in Potsdam. He used general relativity to analyze the geometric region near a singularity (area where the curvature of spacetime reaches an infinite level when it was warped. He set the radius of a black hole equal to 2GM/c^2, where G is the gravitational constant, M is the mass of the black hole, and c is the speed of light. This is known as the Schwarzschild radius, which was coined in 1916."
...
let loft_text = "Set to launch in 2025, the Large Observatory for X-ray Timing is a part of a bigger initiative set forth by the European Space Agency, called their Cosmic Vision programme. The observatory analyzes how matter behaves when it is really close to black holes. The technology they use are X-ray resolutions which should provide accurate spin movements of the mass."
let bhex_text = "As of right now, the theoretical rings of light which surround black holes has not been seen. The Black Hole Explorer (BHEX) uses state-of-the-art optical communications technology to capture this photon ring. If the BHEX succeeds in its mission, physicists will now have a better understanding behind how black holes form. The BHEX is set to launch in 2031."
let missions_texts_container = [chandra_text, roman_text, hubble_text, eht_text, arcus_text, loft_text, bhex_text];
...
let loft_title = "LOFT - ESA"
let bhex_title = "BHEX"
let missions_titles_container = [chandra_title, roman_title, hubble_title, eht_title, arcus_title, loft_title, bhex_title];

const image2 = document.querySelector(".description img")

let images_container = ["images/chandra.jpg", "images/roman.png", "images/hubble.webp", "images/eht.jpg", "images/arcus.jpg", "images/loft.bmp", "images/bhex.png"];
