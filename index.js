...
let intermediate_text = "Intermediate black holes are quite difficult to define. They are larger than stellar-mass black holes but do not reach the size of supermassive black holes. They form from the collisions between multiple stellar-mass black holes, which in-turn create an intermediate-mass black hole. These black holes are tens to hundreds of thousand times the mass of our sun. It is not an understatement to say that physicists struggle to find these black holes much more than stellar or supermassive ones."
